...
export const Step2 = () => {
  ...
  return (
    ...
    >
      ...
      <Box
        className="flex-row"
        sx={{ gap: 1, alignItems: "baseline", justifyContent: "flex-start" }}
      >
        <Typography>
      ...
      <Box className="flex-row-space" sx={{ gap: 2, alignItems: "center" }}>
        <Typography>
          Are you interested in receiving marketing assistance to maximize your
          business?
        </Typography>
        <ButtonGroup size="small">{isRequestingMarketingButtons}</ButtonGroup>
      </Box>
    </Box>
  );
};
